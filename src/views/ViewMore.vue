      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide swiper-third">
          <div class="free-text-button">
            ...
            <a href="#" style="cursor: pointer;position:relative; right: -510px" @click="addGameNum()" >查看更多</a>
          </div>
          <div class="car-tuning1" v-for="index in game_cover.length" :key="index" style="cursor: pointer" @click="jumpGame(game_id[index - 1])">
            <div class="container">
              <div class="box">
                ...
                <div class="game-detail">
                  ...
                  <div>
                    <p class="p-sale-button">-{{100-game_discount[index-1]*100}}%</p>
                    <p class="sale-price-">¥{{game_price[index - 1]}}</p>
                    <p style="position:relative;left: 63%;top:-48px;word-wrap:break-word">{{game_intro[index-1]}}</p>
